...
from ..poe2Client.fileHelper import build_world_key
from ..poe2Client.itemFilter import set_poe_doc_path, DEFAULT_POE_DOC_PATH, poe_doc_path
...
class TestItemFilterPathHandling(PoeTestBase):
    ...
    def test_set_and_get_poe_doc_path(self):
        ...
        import worlds.poe2.poe2Client.itemFilter as itemFilter
